...
/*
 * given a permutation how to sort it using operation?
 * alternating so either start 1 or 2
 *
 * 3 2 1
 * 2 3 1
 * 2 1 3
 ...
 * 6!
 * 0 if already sorted
 * 1 if either 0..n finished or 2n..3n finished
 * 2 if either 0..2n sorted or n..3n sorted?
 * 3 otherwise
 *
 * 0..2n sorted? n!*(3n choose 2n)
 *
 * 0..n finished? 2n!
 *
 * 0..n finished & 2n..3n finished? n!
 * 0..2n sorted & n..3n sorted? 1
 *
 * 0..2n sorted & 0..n finished? n!*(2n choose n)
 * 0..2n sorted & 2n..3n finished? 1
 *
 *
 * 3*(tot)
 * - (either big sorted, no small finished)
 * - 2*(either small finished, no big sorted)
 * - 3*(sorted)
 * 3*(3n)!
 * - (2*n!*(3nc2n)-1-2*n!*(2ncn))
 * - 2*(2*(2n)!-1-2*n!*(2ncn))
 * - 3
 * 1*(2n!+2n!)
 * 2*(
