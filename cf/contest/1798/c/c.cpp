...
int32_t main() {
    ...
    rep(i,0,p_factors.size()) {
        fore(p, primes) if (p > i) break;
        else if (i % p == 0) p_factors[i].insert(p);
    }
