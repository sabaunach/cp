...
bool solve() {
    ...
    string s; cin >> s;
    int i = 0;
    if (tolower(s[i]) != 'm') return false;
    while (i < N && tolower(s[i])=='m') i++;
    if (i >= N) return false;
    if (tolower(s[i]) != 'e') return false;
    while (i < N && tolower(s[i])=='e') i++;
    if (i >= N) return false;
    if (tolower(s[i]) != 'o') return false;
    while (i < N && tolower(s[i])=='o') i++;
    if (i >= N) return false;
    if (tolower(s[i]) != 'w') return false;
    while (i < N && tolower(s[i])=='w') i++;
    if (i < N) return false;
    return true;
}
